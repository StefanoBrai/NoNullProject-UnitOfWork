...
namespace WebApplication1.Controllers
{
    public class SkillController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["ProfId"] = new SelectList(_context.Professionists, "ProfId", "Lastname");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("SkillId,GeneralareaId,ProfId,Level,Description")] Skill skill)
        {
            ...
            ViewData["ProfId"] = new SelectList(_context.Professionists, "ProfId", "Lastname", skill.ProfId);
            return View(skill);
        }
