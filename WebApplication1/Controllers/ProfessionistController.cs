...
namespace WebApplication1.Controllers
{
    public class ProfessionistController : Controller
    {
        ...
        private readonly CollaborationUnitOfWork collaborationUnitOfWork;

        public ProfessionistController (NoNullProjectContext context, CollaborationUnitOfWork collaborationUnitOfWork)
        {
            _context = context;
            this.collaborationUnitOfWork = collaborationUnitOfWork;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await collaborationUnitOfWork.FindAllProfessionistsAsync());
        }
