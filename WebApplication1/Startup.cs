...
using WebApplication1.Models.Repositories.Implementations;
using WebApplication1.Models.UnitOfWork;
using WebApplication1.Models.UnitOfWork.Implementations;
...
namespace WebApplication1
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<RequestRepository, EFRequestRepository>();
            services.AddTransient<CollaborationUnitOfWork, EFCollaborationUnitOfWork>();
